...
| 이름  | 주요 도메인       | 상세 작업                                                             |
| --- | ------------ | ----------------------------------------------------------------- |
| 김진욱 | 인증·랭킹·배포     | 로그인/회원가입 API & UI, Google OAuth2, <br>Spring Security, 랭킹 페이지, EC2 배포 |
| 이소연 | 메인/마이페이지·문서화 | 메인 & 마이페이지 UI, Header/Footer·공통 컴포넌트, <br>README·Notion 관리, 발표 자료     |
| 김예은 | 커뮤니티         | 게시글/댓글/좋아요/스크랩 CRUD, ERD·마이그레이션, <br>Swagger 문서화, 최종 발표               |
| 조권호 | 면접 세션·AI     | Gemini 질문 생성, 앨런 AI 피드백, 결과 리포트, <br>Swagger·시연 영상                    |
...
* **기본 로그인/회원가입**
  ...
  * CSRF, 세션 보안 적용
* **소셜 로그인** <img width="1000" height="400" alt="Image" src="https://github.com/user-attachments/assets/31cff2af-82a1-4b9b-a0ab-24cd1bda0192" />
...
<img width="600" height="800" alt="Image" src="https://github.com/user-attachments/assets/428d8b77-d844-46f1-8467-13f0cbe692a6" />
